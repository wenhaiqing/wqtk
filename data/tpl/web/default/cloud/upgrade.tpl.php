		...
		<div class="row">
			<div class="col-lg-6">
				<div class="alert alert-info refresh-log">
					...
					<script type="text/javascript" src="https://bbs.we7.cc/api.php?mod=js&bid=17"></script>
					</ul>
				</div>
			</div>
			<div class="col-lg-6">
				<div class="alert alert-info refresh-log">
					...
					<ul class="list-unstyled">
					<script type="text/javascript" src="https://bbs.we7.cc/api.php?mod=js&bid=20"></script>
					</ul>
				</div>
			</div>
		</div>
