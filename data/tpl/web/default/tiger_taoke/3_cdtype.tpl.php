                           ...
                           <div class="panel-body">
                                  ...
                                  <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                   ...
                                                   <label class="checkbox-inline">
                                                      <input type="radio" name="fftype" id="fftype" value="1" <?php  if($item['fftype'] == 1) { ?>checked<?php  } ?>> 底部菜单
                                                   </label>
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-8 col-xs-12">
                                            <?php  echo tpl_form_field_link('wlurl', $item['wlurl']);?>
                                            <div class="help-block">【如果先点了上面的选择图片按钮，这个选择链接会失效】选择链接如果点不出来，就刷新一下，或是自己手动填写</div>
                                        </div>
                                   </div>
                        ...
                        <div class="panel panel-default">
                              ...
                              <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                <tr>
                                  ...
                                  <td><?php  if($item['fftype']==1) { ?><span class="btn btn-xs btn-primary">底部菜单</span><?php  } else { ?><span class="btn btn-xs btn-info">个人中心菜单</span><?php  } ?></td>
