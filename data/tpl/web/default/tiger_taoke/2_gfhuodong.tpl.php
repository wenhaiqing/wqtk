			    ...
			    <section class="vbox">
			        <section class="scrollable padder" style="padding-bottom:50px;">
                        <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                          <li><a href="<?php  echo $this->createWebUrl('index')?>"><i class="fa fa-home"></i> 首页  / 官方活动管理</a></li>
                          <li class="active">活动管理</li>
                        </ul>
			            <!--编辑内容-->
                        <ul class="nav nav-tabs">
                            <li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('gfhuodong', array('op' => 'post'));?>">添加</a></li>
                            <li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('gfhuodong', array('op' => 'display'));?>">管理</a></li>
                        </ul>
                        ...
                        <div class="panel panel-default">
                           ...
                           <div class="panel-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                      <input type="text" class="form-control" name="turl" value="<?php  echo $item['turl'];?>"  placeholder="如：http://">
                                    </div>    
                                  </div>  
                                  <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">淘口令</label>
                                    <div class="col-sm-9">
                                      <input type="text" class="form-control" name="kouling" value="<?php  echo $item['kouling'];?>"  placeholder="">
                                    </div>    
                                  </div> 
                                  <div class="form-group">
                              ...
                              <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                <tr>
                                  ...
                                  <td style="text-align:right;">
                                    <a href="<?php  echo $this->createWebUrl('gfhuodong', array('id' => $item['id'], 'op' => 'post'))?>" title="编辑" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>编辑</a>
                                    <a href="<?php  echo $this->createWebUrl('gfhuodong', array('id' => $item['id'], 'op' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" title="删除" class="btn btn-sm btn-default"><i class="fa fa-remove"></i>删除</a>
                                  </td>
                                </tr>
                                <?php  } } ?>
                               </table>
