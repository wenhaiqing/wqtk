			    ...
			    <section class="vbox">
			        <section class="scrollable padder" style="padding-bottom:50px;">
                        ...
                        <ul class="nav nav-tabs">
                            <li <?php  if($_GPC['op']=='post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('fztype', array('op' => 'post'));?>">添加</a></li>
                            <li <?php  if($_GPC['op']=='display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('fztype', array('op' => 'display'));?>">管理</a></li>
                        </ul>
			            <!--编辑内容-->
