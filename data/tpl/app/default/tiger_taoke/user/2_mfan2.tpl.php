...
<div class="ordernav">
        <a href="<?php  echo $this->createMobileUrl('mfan1',array('uid'=>$fans['uid'],'dluid'=>$dluid))?>"><span>我的朋友</span></a>
        <a href="<?php  echo $this->createMobileUrl('mfan2',array('level'=>1,'uid'=>$fans['uid'],'dluid'=>$dluid))?>" class="cur"><span>朋友的朋友</span></a>
...
<div class="allorder">
    ...
    <?php  if($fans1) { ?>
        <?php  if(is_array($fans2)) { foreach($fans2 as $k => $f) { ?>
          <div class="usertx"><span class="userpointer" style="font-size:14px;height:40px;line-height:40px;padding:0"><img src="<?php  echo preg_replace('/\/0$/', '/46', stripslashes($f['avatar']));?>" style="width: 40px; height: 40px;  border-radius: 50%;">&nbsp;&nbsp;&nbsp;<?php  echo $f['nickname'];?></span><span class="usergotx" > No.<?php  echo $k+1?></span></div>
        <?php  } } ?>
    <?php  } else { ?>
        <div class="nocoll">
          <p>您还没有队员哦！~</p>
