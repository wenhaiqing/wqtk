...
<script>
    ...
    <ul class="am-tabs-nav am-nav am-nav-tabs" id="nav2">
        <li style="padding-right:0;padding-left:0;"><a href="<?php  echo $this->createMobileUrl('sdindex')?>">晒单广场</a></li> 
        <li  class="am-active" style="padding-right:0;padding-left:0;"><a href="<?php  echo $this->createMobileUrl('sdmy')?>">我的晒单</a></li>
        <!--li style="padding-right:0;padding-left:0;"><a href="/share/ranking.html">积分排行</a></li-->
        <li style="float:right;"><a class="am-fr am-text-sm am-padding-horizontal-xs top_refer" style="background-color:#FFF;border:.1rem solid #F3E7E3;padding-top:3px;padding-bottom:3px;margin-top:6px;margin-bottom:3px;" href="<?php  echo $this->createMobileUrl('sdadd')?>">晒单发布</a>
        </li>
    </ul>
    <style>
        #nav2{
            ...
            <li class="">
                ...
                <div class="am-margin-horizontal-sm">
                    ...
                    <div class="am-margin-top-xs star">
                        ...
                        <div class="am-inline">
                            <span style="margin-left:-3px;">到手价: <span class="am-text-sm" style="font-weight:400;color:#f54d23"><?php  echo $l['price'];?></span>元</span><span style="margin-left:4px;"><?php  if($l['jljf']<>'') { ?>奖励积分: <span class="am-text-sm"><?php  echo $l['jljf'];?></span><?php  } ?>

                            <?php  if($l['jljf']<>'') { ?>
                            <span style="color:#136ec2">已审核</span>
                            <?php  } else { ?>
...
<div class="menu">
        <ul class="am-avg-sm-3 am-text-center am-padding-top-xs">
            ...
            <li  class="am-vertical-align">
                <a href="<?php  echo $cfg['huiyuanurl'];?>">
