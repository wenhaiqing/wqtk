...
<link rel="stylesheet" type="text/css" href="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style1/css/style.css?t=4" />
...
<div class="safari_top">
    ...
    <div class="safari_img am-text-right" onclick="hidetip()">
        ...
        <img id="go_tip" src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style1/css/jump_coupon_android.png" alt="" />
