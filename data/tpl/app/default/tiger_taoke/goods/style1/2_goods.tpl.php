...
<title><?php  if($cfg['hztype']<>'') { ?><?php  echo $cfg['hztype'];?><?php  } else { ?>积分<?php  } ?>兑换</title>
...
<script>
    ...
    <div class="am-message am-vertical-align am-padding-horizontal-sm am-margin-bottom-xs">
        <img src="<?php  echo $fans['avatar'];?>" class="am-round am-vertical-align-middle am-portrait" />
        <span class="am-vertical-align-middle am-margin-left-sm" style="margin-top: .2rem">我的<?php  if($cfg['hztype']<>'') { ?><?php  echo $cfg['hztype'];?><?php  } else { ?>积分<?php  } ?>：</span>
        <span class="am-vertical-align-middle integral-fraction myscore" style="margin-top: .2rem"><?php  echo number_format($credit)?></span>
    ...
    <nav>
        <div class="am-tabs am-padding-horizontal-xs">
            <ul class="am-tabs-nav am-nav am-nav-tabs" style="height: 36px">
                <li <?php  if($type=='') { ?>class="am-active"<?php  } ?>><a href="<?php  echo $this->createMobileUrl('goods',array('dluid'=>$dluid))?>" style="padding-left: 10px; padding-right: 10px">全部</a></li>
                <li <?php  if($type=='sw') { ?>class="am-active"<?php  } ?>><a href="<?php  echo $this->createMobileUrl('goods', array('type' =>'sw','dluid'=>$dluid))?>" style="padding-left: 10px; padding-right: 10px">实物产品</a></li>
                <li <?php  if($type=='xn') { ?>class="am-active"<?php  } ?>><a href="<?php  echo $this->createMobileUrl('goods', array('type' =>'xn','dluid'=>$dluid))?>" style="padding-left: 10px; padding-right: 10px">虚拟产品</a></li>
                        ...
                        <li>
                                <div class="am-articles am-thumbnail am-margin-top-xs" style="margin-left:0.5rem;margin-right:0;">
                                    ...
                                    <div class="am-padding-horizontal-xs">
                                        <span><strong class="line-clamp am-margin-bottom-xs"><?php  echo $item['title'];?></strong></span>
                                        
                                        <span class="credit am-fl"><?php  if($cfg['hztype']<>'') { ?><?php  echo $cfg['hztype'];?><?php  } else { ?>积分<?php  } ?>：<span class="am-credit"><?php  echo $item['cost'];?></span></span>
                                         <br />
                                         <span class="price am-fl">市场价：¥<span class="am-price"> <?php  echo $item['price'];?></span></span>
                                        <br />
                                        <div class="am-num ">
                                            <span><span class="am-convert"><?php  echo $item['requestsum'];?></span> 人兑换</span>
                                            <span class="am-fr"><span class="am-stick"><?php  echo $item['amount'];?></span> 库存</span> 
                                             <br />
                                        </div>
