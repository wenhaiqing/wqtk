...
<?php  if(is_array($list)) { foreach($list as $v) { ?>
        <li class="relative">
            ...
            <a href="javascript:;" class="new-coupon" data-img="<?php  echo tomedia($v['pic_url'])?>_240x240.jpg"  data-rxyjxs="<?php  echo $cfg['rxyjxs'];?>" data-id="<?php  echo $v['id'];?>"><span>马上领劵</span><span>立减<em class="ljmoney"><?php  echo $v['coupons_price'];?></em>元</span></a>
            </div>
            </div>
        </li>
      <?php  } } ?>
...
<script>
        $(function () {
            if ($("#lists li").length < 1) {
                ...
                html += '<div class="miaotui"><a href="<?php  echo $this->createMobileUrl('index')?>">首页</a></div>';
                html += '</div>';
