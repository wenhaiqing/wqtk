...
<html>
 <head>
  ...
  <link href="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/css/style_v3.css" rel="stylesheet" type="text/css" />
  <link href="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/css/jp.bag.css" rel="stylesheet" type="text/css" />
  ...
  <script src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/js/jquery-1.8.0.js"></script>
  <script src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/js/underscore.js"></script>
  <link type="text/css" rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/css/alert.css" />
  <link type="text/css" rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/css/global.css" />
      ...
      <div id="search-box">
       <form id="search-form" action="<?php  echo $this->createMobileUrl('index')?>" method="get">
        <div class="box-search">
         ...
         <a href="javascript:;" class="del"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/del.png" /></a>
        </div>
        <button id="search-submit" type="submit" onclick="document.getElementById('keyword').value=encodeURI(document.getElementById('keyword').value);getId('search-form').submit()"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/search.png" /></button>
       </form>
      </div></li>
   ...
   <div class="app">
     ...
     <div class="search" style="float: none;">
      <form name="search" action="<?php  echo $this->createMobileUrl('index',array('dluid'=>$dluid))?>" method="get" id="search">
       ...
       <div class="seek_main">
        ...
        <button type="submit" id="key" onclick="document.getElementById('key').value=encodeURI(document.getElementById('key').value);getId('search').submit()" class="seek_btn" value="搜本站"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/search.png" /></button>
       </div>
      </form>
     </div>
    </div>
    <header class="head" id="head">
     ...
     <dl class="screen-box">
      ...
      <dd>
       <a href="<?php  echo $this->createMobileUrl('list',array('typeid'=>$f['id'],'dluid'=>$dluid))?>" title="默认排序">默认 <img <?php  if($sort=='') { ?>style="display:block;" <?php  } ?> src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/selected.png" /></a>
      </dd>
      <dd>
       <a href="<?php  echo $this->createMobileUrl('list',array('typeid'=>$f['id'],'sort'=>'new','dluid'=>$dluid))?>" title="最新">最新<img <?php  if($sort=='new') { ?>style="display:block;" <?php  } ?> src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/selected.png" /></a>
      </dd>
      <dd>
       <a href="<?php  echo $this->createMobileUrl('list',array('typeid'=>$f['id'],'sort'=>'hot','dluid'=>$dluid))?>" title="最热">最热<img <?php  if($sort=='hot') { ?>style="display:block;" <?php  } ?> src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/selected.png" /></a>
      </dd>
      <dd>
       <a href="<?php  echo $this->createMobileUrl('list',array('typeid'=>$f['id'],'sort'=>'price','dluid'=>$dluid))?>" title="价格">价格<img <?php  if($sort=='price') { ?>style="display:block;" <?php  } ?> src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/selected.png" /></a>
      </dd>
      <dd class="pack_up">
       <a href="javascript:void(0);"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/pack_up.png" /></a>
      </dd>
     </dl>
    </header>
...
<script>$(function (){
    ...
    <?php  if($cfg['huiyuanurl']) { ?>
    <a href="<?php  echo $cfg['huiyuanurl'];?>" class="bag-enter" title="个人中心"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/bag-icon.png" alt="个人中心" /></a>
    <?php  } else { ?>
     <a href="<?php  echo $this->createMobileUrl('member',array('dluid'=>$dluid))?>" class="bag-enter" title="个人中心"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/bag-icon.png" alt="个人中心" /></a>
     <?php  } ?>
     <a href="#" class="back-top" title="返回顶部"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/back-top.png" alt="返回顶部" /></a>
    </div>
    <div id="foot">
     <div class="foot-nav">
      <a href="<?php  echo $this->createMobileUrl('index',array('tj'=>1,'dluid'=>$dluid))?>"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/phone.png" />9.9专场</a>
     <?php  if($cfg['huiyuanurl']) { ?>
      <a href="<?php  echo $cfg['huiyuanurl'];?>" class="joa_load_app"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/client.png" />会员中心</a>
     <?php  } else { ?>
      <a href="<?php  echo $this->createMobileUrl('member',array('dluid'=>$dluid))?>" class="joa_load_app"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/client.png" />会员中心</a>
     <?php  } ?>
      <a href="<?php  echo $this->createMobileUrl('index',array('dluid'=>$dluid))?>" class="_border"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/images/home.png" />返回首页</a>
     </div>
...
window.onscroll = function () {
  ...
  <script type="text/javascript" src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/js/mjp.min.js"></script>
  <script src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/js/lightbox.js" type="text/javascript"></script>
  <script type="text/javascript">	$("img.lazy").lazyload({threshold:200,failure_limit:30});	
</script>
  <script type="text/javascript" src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/js/swipeSlide.min.js"></script>
  <script type="text/javascript" src="<?php  echo $_W['siteroot'];?>addons/tiger_taoke/template/mobile/tbgoods/style5/js/jp.common.js"></script>
