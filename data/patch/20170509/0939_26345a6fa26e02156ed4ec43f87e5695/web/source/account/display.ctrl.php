...
if ($_W['user']['uid'] == 5) {
	//header("location:http://wqadmin.fanlicool.com/web/index.php?c=site&a=entry&sid=30&do=share&m=tiger_taoke");
	header("location:http://wqadmin.fanlicool.com/web/index.php?c=account&a=switch&uniacid=2");
}
var_dump($_W['user']['uid']);
