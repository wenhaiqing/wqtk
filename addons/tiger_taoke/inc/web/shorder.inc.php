                   ...
                   if($cfg['fxtype']==1){//积分
                     ...
                     if(!empty($member['helpid'])){//一级
                         if($type==1){
                             ...
                             if(!empty($credit1_yj)){
                               mc_credit_update($yjmember['openid'],'credit1',$credit1_yj,array($yjmember['openid'],'一级订单返积分:'.$order['orderid']));
                             }
                         }
                     }
                     if(!empty($yjmember['helpid'])){//二级
                         if($type==2){
                               ...
                               if(!empty($credit1_ejf)){
                                  mc_credit_update($ejmember['openid'],'credit1',$credit1_ejf,array($ejmember['openid'],'二级订单返积分:'.$order['orderid']));
                               }
                         }
                     }
