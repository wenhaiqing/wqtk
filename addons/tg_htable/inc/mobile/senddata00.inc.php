...
//var_dump($_GPC);
$elements = array(
		"number"	=> '<input type="text" class="form-control" name="aa[]" placeholder="请输入" />',
		"string"	=> '<input type="text" class="form-control" name="aa[]" placeholder="请输入" />',
		"image"		=> '<input type="text" class="form-control" name="aa[]" placeholder="请输入" />',
		"time"		=> '<input type="text" class="form-control" name="aa[]" placeholder="请输入" />',
		"text"		=> '',
		"radio"		=> '',
		"select"	=> '',
		"checkbox"	=> ''
	...
	switch($type){
		...
		case 'string':
			$html = '<div class="form-group">
    				   ...
    				   <div class="col-sm-10">
      				 <input type="text" name="tgnet_htb[]" class="form-control" placeholder="请输入'.$name.'"/>
    				   </div>
  					   </div>';
		break;
		case 'text':
			$html = '<div class="form-group">
               <label class="col-sm-2 control-label">'.$name.'</label>
               <div class="col-sm-10">
               <textarea name="tgnet_htb[]" class="form-control" rows="3"></textarea>
               </div>
               </div>';
		break;
    case 'time':
      return tpl_app_form_field_calendar($name, $values = array());
    break;
    case 'image':
      return tpl_app_form_field_image($name, $value = '');
    break;
		case 'checkbox':
			$html = '<div class="form-group">
    				   <label class="col-sm-2 control-label">'.$name.'</label>
